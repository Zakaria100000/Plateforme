...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO student (id,firstname,lastname,username,password,role) VALUES (?,?,?,?,?,?)");

        if($stmt->execute([ $id,$firstname,$lastname,$username,$password,$role  ])) {
                $stmt = null;
                header("location: student-index.php");
            } else{
                echo "Une erreur est survenu. prière de réessayer.";
            }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <p>Veuillez remplir ce formulaire et le soumettre pour ajouter un enregistrement à la base de données.</p>
